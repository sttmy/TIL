...
listData2 = Listbox(listFrame, bg = 'red');   listData2.pack(side=LEFT, fill=BOTH, expand=1)
listData3 = Listbox(listFrame, bg = 'blue');   listData3.pack(side=LEFT, fill=BOTH, expand=1)
listData4 = Listbox(listFrame, bg = 'green');   listData4.pack(side=LEFT, fill=BOTH, expand=1)
